resource "dynatrace_web_application" "FXF-3541738-FedExFreight_com-AEM-NP" {
  name                                 = "FXF-3541738-FedExFreight_com-AEM-NP"
  ...
  monitoring_settings {
    ...
    monitoring_data_path                 = "https://bf60523wsv.bf.dynatrace.com/bf"
