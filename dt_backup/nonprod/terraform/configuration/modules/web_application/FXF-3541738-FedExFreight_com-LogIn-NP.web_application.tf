resource "dynatrace_web_application" "FXF-3541738-FedExFreight_com-LogIn-NP" {
  name                                 = "FXF-3541738-FedExFreight_com-LogIn-NP"
  type                                 = "AUTO_INJECTED"
  ...
  monitoring_settings {
    ...
    library_file_location                = "/login/"
    monitoring_data_path                 = "/login/"
