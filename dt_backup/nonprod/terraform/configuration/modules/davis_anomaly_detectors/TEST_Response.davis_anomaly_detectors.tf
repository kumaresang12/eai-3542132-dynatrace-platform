resource "dynatrace_davis_anomaly_detectors" "TEST_Response" {
  description = ""
  enabled     = true
  ...
  analyzer {
    ...
    input {
      ...
      analyzer_input_field {
        ...
        value = "[ENVIRONMENT]fedex.eai_num:3541742"
      }
      analyzer_input_field {
      ...
      analyzer_input_field {
        ...
        value = "pcf.organization_name:3541742"
      }
      analyzer_input_field {
        key   = "slidingWindow"
        value = "5"
      ...
      analyzer_input_field {
        ...
        value = "PcfOrganization:3541742"
      }
      analyzer_input_field {
        key   = "query.filterSegments[0].variables[4].values[0]"
        value = "[ENVIRONMENT]fxf.eai_num:3541742"
      }
      analyzer_input_field {
      ...
      analyzer_input_field {
        ...
        value = "[ENVIRONMENT]fxf-eai-num:3541742"
      }
      analyzer_input_field {
        ...
        value =<<-EOT
          ...
          timeseries count = avg(dt.frontend.request.duration, scalar: true), filter: {frontend.name == "FXF-3541742-FedExFreight_com-Tracking"}
        EOT
      }
      analyzer_input_field {
      ...
      analyzer_input_field {
        ...
        value = "[ENVIRONMENT]dt.security_context:3541742"
      }
    }
  }
  event_template {
  ...
  execution_settings {
    actor = "35fd0a49-a6ea-4ff7-9052-d5864c1c408b"
  }
}
