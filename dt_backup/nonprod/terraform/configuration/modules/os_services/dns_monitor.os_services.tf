resource "dynatrace_os_services" "dns_monitor" {
  name                      = "dns monitor"
  enabled                   = true
  alert_activation_duration = 1
  alerting                  = true
  insert_after              = "vu9U3hXa3q0AAAABAB5idWlsdGluOm9zLXNlcnZpY2VzLW1vbml0b3JpbmcABEhPU1QAEDFEOUNBRkYwRjJFMzVBQjYAJDVkMDNiYTU0LTYwZjAtMzRlYS1hY2QxLTBhMDNjNmJkOGE0Nb7vVN4V2t6t"
  monitoring                = true
