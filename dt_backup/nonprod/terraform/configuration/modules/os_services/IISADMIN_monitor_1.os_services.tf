resource "dynatrace_os_services" "IISADMIN_monitor_1" {
  name                      = "IISADMIN monitor"
  enabled                   = true
  alert_activation_duration = 1
  alerting                  = true
  insert_after              = "vu9U3hXa3q0AAAABAB5idWlsdGluOm9zLXNlcnZpY2VzLW1vbml0b3JpbmcABEhPU1QAEEE0NjIyOThDM0ZENDBGNEEAJGIyNzEwYTMzLTk4NTgtMzZmYy1iMDhhLTRiZTMyNDMxZWQ5Nr7vVN4V2t6t"
  monitoring                = true
