resource "dynatrace_os_services" "IsmServ_monitor" {
  name                      = "IsmServ monitor"
  enabled                   = true
  alert_activation_duration = 1
  alerting                  = true
  insert_after              = "vu9U3hXa3q0AAAABAB5idWlsdGluOm9zLXNlcnZpY2VzLW1vbml0b3JpbmcABEhPU1QAEDFEOUNBRkYwRjJFMzVBQjYAJDc0MzkwZDI2LTAwYjktMzhkYy1hZjc3LTE3MmRmZWMzNmYyY77vVN4V2t6t"
  monitoring                = true
