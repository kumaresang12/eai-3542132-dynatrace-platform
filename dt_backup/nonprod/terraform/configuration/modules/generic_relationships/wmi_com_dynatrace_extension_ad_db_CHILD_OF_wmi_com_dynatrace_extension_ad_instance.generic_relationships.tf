resource "dynatrace_generic_relationships" "wmi_com_dynatrace_extension_ad_db_CHILD_OF_wmi_com_dynatrace_extension_ad_instance" {
  enabled          = true
  created_by       = "com.dynatrace.extension.active-directory-python-unabridged 6.1.1"
  from_type        = "wmi:com_dynatrace_extension_ad_db"
